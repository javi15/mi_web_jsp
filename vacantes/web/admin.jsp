<%-- 
    Document   : admin
    Created on : Jun 14, 2018, 10:39:44 AM
    Author     : javier
--%>
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item  flase">
        <a class="nav-link" href="admin?action=crear">Crear <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
    ...
    <div class="panel-body">
        ...
        <h5><b>Tipo Usuario : </b> ${usuario.nombre} </h5>
        <h5><b>Status : </b> ${usuario.status} </h5>
        <h5><b>Perfil : </b> ${usuario.perfil} </h5>
